...
{
    /// <inheritdoc />
    public partial class AssessmentWeek13Enhancements : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailabilitySchedule = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Dermatology", "Skin and hair treatment" },
                    { 3, "Neurology", "Brain and nervous system" },
                    { 4, "Orthopedics", "Bones and joints" },
                    { 5, "General Medicine", "Primary and general care" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Skin conditions", "Dermatology" },
                    { 3, "Nervous system disorders", "Neurology" },
                    { 4, "Musculoskeletal system", "Orthopedics" },
                    { 5, "Children's health", "Pediatrics" },
                    { 6, "General health care", "General Medicine" }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedAt", "Email", "FullName", "PasswordHash", "Role" },
                values: new object[] { 1, new DateTime(2026, 4, 6, 4, 50, 25, 718, DateTimeKind.Utc).AddTicks(7945), "admin@healthcare.com", "System Admin", "$2a$11$YJ3zSDJXvt8W/2aikInDGe1qT8Bf2qXaItCPtAJkS3M/g.Y/Vm10K", "Admin" });
